...
struct ModelPost {
    ...
    static func createModelPost() -> [ModelPost] {
        ...
        modelPost.append(ModelPost(author: "RBK", description: "Минторг США сообщил о падении на 90% экспорта полупроводников в Россию", image: "rbk.jpg", likes: 200, views: 200))
